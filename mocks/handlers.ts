    ...
    if (category === '전체') {
      ...
      return HttpResponse.json([
        ...
        },
        {
          ...
          memberCount: 10,
          imageSrc:
            'https://images.unsplash.com/photo-1595624871930-6e8537998592?q=80&w=2671&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
        }
      ]);
    }
