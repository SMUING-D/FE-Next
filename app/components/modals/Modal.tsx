      ...
      <div className="flex items-center justify-center overflow-x-hidden overflow-y-auto fixed inset-0 bg-neutral-600/70 z-50 focus:outline-none ">
        <div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/6 my-6 mx-auto h-100dvh lg:h-auto md:h-auto max-h-screen">
          <div
            ...
            `}
          >
            <div className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none dark:bg-medium">
              <div className="flex items-center p-6 rounded-6 justify-center relative border-b-[1px]">
                <button
                  onClick={handleClose}
                  className="p-1 border-0 absolute left-9 hover:opacity-70  transition dark:text-white"
                >
                  <IoMdClose size={18} />
                </button>
                <div className="text-lg font-semibold dark:text-white">{title}</div>
              </div>
              <div className="relative p-6 dark:text-white">{body}</div>
              <div className="flex flex-col gap-2 p-6">
                <div className="flex flex-row items-center gap-4 w-full dark:text-white">
